...
\textbf{Meta learning:} Aims to develop a learning paradigm capable of acquiring knowledge that generalizes across a variety of (possibly new) tasks (see Fig. \ref{fig:Architecture} for an overview). This concept of 
...
\textcolor{red}{In the preliminaries describe briefly the spidermark}
