...
In the logged 2000-step agentic run and in the released training code, we start with a conservative residual budget of $\rho_t=0.15$ and switch to $\rho_t=0.5$ at meta-training step 400.
